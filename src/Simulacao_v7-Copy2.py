# Converted from Simulacao_v7-Copy2.ipynb
# --- Cell 1 ---
import numpy as np
import random
import pandas as pd
...
plt.hist(np.random.lognormal(7.20, 0.2, size=100000))
# --- Cell 7 ---
...
for n in range(linhas):
    log = []
    sql = "INSERT INTO jpcosta.operacoes3( ref, cliente, porte, contrato, modalidade, prazo, valor, mes, dia, prob_opr, prob_cli, atraso, pgto ) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s) RETURNING *;"
